...
@Service
@Slf4j
public class GenericN8NServiceImpl<T, R> implements GenericN8NService<T, R> {
    ...
    public N8NChatResponse<R> sendMessageWithParams(T message, Map<String, Object> additionalParams, String workflowId, String webhookUrl) {
        try {
            ...
            return N8NChatResponse.<R>error("N8N_ERROR", "Failed to send message with params: " + e.getMessage());
        }
    }
}
